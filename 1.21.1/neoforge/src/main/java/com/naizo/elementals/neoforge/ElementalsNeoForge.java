...
public class ElementalsNeoForge {
    ...
    private static void registerContent() {
        DeferredHolder<EntityType<?>, EntityType<FireSignatureEntity>> fireSignature = ENTITIES.register("fire_signature",
        ...
        DeferredHolder<EntityType<?>, EntityType<ExplosiveFireOrbEntity>> explosiveFireOrb = ENTITIES.register("explosive_fire_orb",
        ...
        DeferredHolder<EntityType<?>, EntityType<FireGolemEntity>> fireGolem = ENTITIES.register("fire_golem",
