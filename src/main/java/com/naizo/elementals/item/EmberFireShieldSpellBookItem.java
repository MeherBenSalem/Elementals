...
import com.naizo.elementals.procedures.EmberShieldSpellBookOnRightClickProcedure;
...
public class EmberFireShieldSpellBookItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmberShieldSpellBookOnRightClickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
